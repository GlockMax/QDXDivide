...
//////////////////////////////////////////////////////////////////////
/// TreeCtrl, умеющий менять цвета и шрифт у элементов
/** В MFC нет этих возможностей, адрес проекта http://www.codeproject.com/KB/tree/colortreectrl.aspx
*/
class CTreeCtrlColor : public CTreeCtrlCh
{
	DECLARE_DYNAMIC(CTreeCtrlColor)

public:
					CTreeCtrlColor();
	virtual			~CTreeCtrlColor();
