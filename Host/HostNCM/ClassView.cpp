...
void CClassView::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized)
{
...
void CClassView::OnActivateApp(BOOL bActive, DWORD dwThreadID)
{
	CDockablePane::OnActivateApp(bActive, dwThreadID);

	// TODO: Add your message handler code here
}


void CClassView::OnKillFocus(CWnd* pNewWnd)
{
