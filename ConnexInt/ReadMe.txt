========================================================================
    ACTIVE TEMPLATE LIBRARY : ConnexInt Project Overview
========================================================================

AppWizard has created this ConnexInt project for you to use as the starting point for
...
_ConnexInt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ConnexInt.h)
        GUID definitions                                (_ConnexInt_i.c)
        A type library                                  (_ConnexInt.tlb)
        Marshaling code                                 (_ConnexInt_p.c and dlldata.c)
ConnexInt.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named ConnexInt.pch and a precompiled types file named StdAfx.obj.
...
ConnexIntps.vcproj
	...
	dlldata.c, ConnexInt_i.c and ConnexInt_p.c which are required
