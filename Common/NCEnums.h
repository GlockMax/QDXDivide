...
enum CollLogElemType
{
	LE_NOTDEFINED = IDS_EN_NOTDEFINED,
	LE_COLLISION = IDS_EN_COLLISION,
	LE_OUTOFRANGE = IDS_EN_OUTOFRANGE,
	LE_COLLTOOL = IDS_EN_TSC,
	LE_COLLHOLD = IDS_EN_TSC_HOLD,
	LE_COLLSHANK = IDS_COLLSHANK,
	LE_COLLVERT = IDS_EN_NOT_DRILLING,
	LE_EMPTYTOOL = IDS_MES_ERR_TOOL,
	LE_NOCOLL = 0
};
